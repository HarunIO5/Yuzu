...
std::expected<void, AuthDBError> AuthDB::create_schema() {
    ...
    const std::vector<Migration> kMigrations = {
        ...
        // v5: JIT admin elevation eligibility (SOC 2 CC6.3 least-privilege /
        ...
        // enumerable for access reviews. RENUMBERED v4 → v5 at merge: the
        // break-glass PR (#1735) landed its own v4 on dev first (#1748 H2).
        {5, R"(
